...
class Event
{
     ...
     * @Groups({"get_events_list", "get_events_item", "get_regions_item", "get_search_item", "get_genres_item"})
     */
    private $id;

    /**
     * @ORM\Column(type="string", length=50)
     * @Groups({"get_events_list", "get_events_item", "get_search_item", "get_genres_item"})
     */
    private $name;
     ...
     * @Groups({"get_events_list", "get_events_item", "get_genres_item", "get_search_item"})
     */
    private $date;
     ...
     * @Groups({"get_events_list", "get_events_item", "get_regions_item", "get_genres_item", "get_genres_item"})
     */
